...
public class CustomBottomNavigationView1 extends BottomNavigationView {
    ...
    private final int CURVE_CIRCLE_RADIUS = 32 / 2;
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.bottomBar));
...
//        mPath.quadTo(mNavigationBarWidth/3,mNavigationBarHeight/3,(mNavigationBarWidth/3)+5,(mNavigationBarHeight/3)+5);
        mPath.close();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            canvas.clipOutRect((mNavigationBarWidth/2)-160,mNavigationBarHeight/3,(mNavigationBarWidth/2)-200,(mNavigationBarHeight/3)+40);
            canvas.clipOutRect((mNavigationBarWidth/2)+160,mNavigationBarHeight/3,(mNavigationBarWidth/2)+200,(mNavigationBarHeight/3)+40);
